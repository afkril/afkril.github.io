		...
		const UDS_DATA = {
		    '665': [
		        ...
		        ['LOS CARIÑOSITOS', '4100100043894'],
		        ['LOS CHUPETINES', '4100100038177'],
		        ['LOS DUMIS.', '4100100115770'],
		        ['LOS JUGUETONES.', '4100100115796'],
		        ['LOS PINGUINOS', '4100100041027'],
		        ['MAFALDA', '4100100115757'],
		        ['MIS 15 ANGELITOS', '4100100041374'],
		        ['MIS AMIGUITOS.', '4100100115793'],
		        ['MIS ANGELITOS', '410011123928'],
		        ['MIS ANGELITOS.', '4100100115781'],
		        ['MIS CAPULLOS', '4100100040968'],
		        ['MIS PEQUEÑOS GIGANTES', '4100100040991'],
		        ['MIS PEQUEÑOS PUPILOS', '4100100115788'],
		        ['MIS PEQUEÑOS SALTARINES', '4100100041008'],
		        ['MIS PEQUEÑOS SALTARINES', '4100100047851'],
		        ['NIÑOS FELICES', '4100100041394'],
		        ['PLUTO.', '4100100115774'],
		    ],
		    '667': [
		        ['BLANCA NIEVES', '4100100078903'],
		        ['CHIQUILLADAS', '4100100120110'],
		        ['DIAS FELICES', '4100100023616'],
		        ['LA RANA RENE', '4100100120291'],
		        ['LOS CHIQUITINES', '4100100112390'],
		        ['LOS EXPLORADORES', '4100100023662'],
		        ['LOS PITUFOS', '4100100127770'],
		        ['MI MUNDO FELIZ', '4100100023780'],
		        ['MI PEQUEÑO MUNDO', '4100100023816'],
		        ['MI PRIMER PASO', '4100100045206'],
		        ['MIS CHIQUITINES', '4100100024111'],
		        ['MIS PASTORCITOS', '4100100023682'],
		        ['MIS PATICOS', '4100100023459'],
		        ['MIS PEQUEÑOS ANGELITOS', '4100100029904'],
		        ['MIS PICARDIAS', '4100100044836'],
		        ['MIS PIRUETAS', '4100100128106'],
		        ['PEQUEÑOS GIGANTES', '4100100120109'],
		        ['SEMILLITAS', '4100100024235'],
		    ],
		    '676': [
		        ['ALEGRIA', '4100100085789'],
		        ['BAMBIS 2', '4100100083331'],
		        ['BAMBY', '4100100091036'],
		        ['BURBUJITAS', '4100100043041'],
		        ['CASITA ENCANTADA', '4100100085784'],
		        ['HOGAR FELIZ', '4100100085820'],
		        ['LA PEQUEÑA LULU', '4100100085809'],
		        ['LOS ANGELITOS', '4100100043056'],
		        ['LOS CARIÑOSITOS', '4100100091312'],
		        ['LOS SIMPSONS', '4100100041466'],
		        ['MI PEQUEÑA CASITA', '4100100085800'],
		        ['MIS AMIGUITOS', '4100100043065'],
		        ['MIS CORAZONSITOS', '4100100024142'],
		        ['MIS OSITOS', '4100100107660'],
		        ['MIS PEQUEÑOS ANGELITOS', '4100100115738'],
		        ['PICAPIEDRAS', '4100100043022'],
		        ['SABIDURIA', '4100100085779'],
		    ],
		}
	   ...
	   const DE_LABELS = ['-3DE', '-2DE', '-1DE', 'Mediana', '+1DE', '+2DE', '+3DE'];
        ...
        function populateUDSFilter() {
            ...
            if (filterUDS) {
                ...
                Object.values(UDS_DATA).flat().forEach(([name, code]) => {
        ...
        function cargarConfigBloqueo() {
            const configRef = database.ref('configBloqueo_JER');
        ...
        document.addEventListener('DOMContentLoaded', () => cargarConfigBloqueo());
        ...
        function loadResumenStats() {
            ...
            const archivedRef = database.ref('archived');
        ...
        function loadContractChart(novelties) {
            ...
            const c665 = novelties.filter(n => n.contract === '665').length;
            const c667 = novelties.filter(n => n.contract === '667').length;
            const c676 = novelties.filter(n => n.contract === '676').length;
        ...
        function marcarTodosCargados() {
            ...
            const promesas = pendientesFiltrados.map(novedad => {
                ...
                return database.ref(`novelties/${novedad.id}`).update(updates)
                    .then(() => {
                        actualizados++;
        ...
        function archivarTodosCargados() {
            ...
            const promesas = cargadosFiltrados.map(novedad => {
                ...
                const archivedRef = database.ref('archived').push();
                
                return archivedRef.set(archivedData)
                    .then(() => database.ref(`novelties/${novedad.id}`).remove())
                    .then(() => {
                        archivados++;
        ...
        function toggleCuentame(id) {
            ...
            const noveltyRef = database.ref(`novelties/${id}`);
            noveltyRef.update({ 
        ...
        function archivarNovelty(id) {
            ...
            archivedRef.set(archivedData)
                .then(() => database.ref(`novelties/${id}`).remove())
                .then(() => {
...
async function cargarDatosNutricionales() {
    ...
    try {
        const [activasSnap, archivadasSnap] = await Promise.all([
            database.ref('novelties').once('value'),
            database.ref('archived').once('value')
        ]);
...
function graficarPorContrato() {
    ...
    if (estadoFiltrado && estadoFiltrado !== 'Sin datos') {
        ...
        datasets = [{
            ...
            data: ['665', '667', '676'].map(c => porContrato[c][estadoFiltrado] || 0),
            backgroundColor: ['665', '667', '676'].map(c => {
                // Color más intenso si tiene más casos
        ...
        datasets = estadosUnicos.map((estado, idx) => ({
            label: estado,
            data: ['665', '667', '676'].map(c => porContrato[c][estado] || 0),
        ...
        function exportToExcelFull() {
            ...
            noveltiesRef.once('value', (snapshot) => {
                ...
                const resumenData = [
                    ...
                    ['Por Contrato 665:', novelties.filter(n => n.contract === '665').length],
                    ['Por Contrato 667:', novelties.filter(n => n.contract === '667').length],
                    ['Por Contrato 676:', novelties.filter(n => n.contract === '676').length],
                ];
            ...
            if (form) {
                form.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        await database.ref('novelties').push(noveltyData);
