		...
		// Lista ordenada de tallas disponibles en la tabla LMS (0.5 en 0.5, de 65 a 120)
		...
		// ── Interpola M y S para una talla exacta (con decimales) ──
		...
		// ── Z-score exacto (método LMS oficial OMS / mismo método del ICBF-Cuéntame) ──
		...
		// ── Peso correspondiente a una desviación estándar (Z) exacta, para dibujar curvas ──
		...
		// ── Z-score genérico (usado también por calcularEstadoNutricionalDirecto) ──
		// tipo: 'PT' = Peso/Talla (única tabla disponible en este módulo, 2-5 años, 65-120cm)
